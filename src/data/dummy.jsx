...
export const product1 = "./pictures/product1.jpg";
export const product2 = "./pictures/product2.jpg";
export const product3 = "./pictures/product3.jpg";
export const product4 = "./pictures/product4.jpg";
export const product5 = "./pictures/product5.jpg";
export const product6 = "./pictures/product6.jpg";
export const product7 = "./pictures/product7.jpg";
export const product8 = "./pictures/product8.jpg";
import {
  BsTruck,
  BsCashStack,
  BsGraphUp,
...
export const queuee=[
  {
    id: 1,
    name: 'Product SKU‑A123',
    img: 'https://short-link.me/127Uj',
  },
  {
    id: 2,
    name: 'Product SKU‑B456',
    img: 'https://short-link.me/127UL',
  },
  {
    id: 3,
    name: 'Refund Request #3021',
    img: 'https://short-link.me/127V8',
  },
  {
    id: 4,
    name: 'Vendor Listing SKU‑C789',
    img: 'https://short-link.me/16kkA',
  },
  {
    id: 5,
    name: 'Order #23892 – Address Change',
    img: 'https://short-link.me/16kkN',
  },
  {
    id: 6,
    name: 'Product SKU‑D012 (New Color)',
    img: 'https://short-link.me/16kl5',
  },
  {
    id: 7,
    name: 'Bulk Price Update – 17 SKUs',
    img: 'https://short-link.me/16kkA',
  },
  {
    id: 8,
    name: 'Customer Request #9042 (VIP)',
    img: 'https://short-link.me/16kl5',
  },
]
export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded-xl h-20 md:ml-3 w-25  hover:drop-shadow-xl"
...
function getStatusColor(status) {
  const colors = {
    pending: '#FCD34D',     // Soft Amber
    rejected: '#cbcbcb',    // Soft Red
    active: '#93C5FD',      // Soft Blue
    completed: '#44D7A8',   // Mint Green
    canceled: '#fa864c'     // Lavender
  };

  const key = status.toLowerCase();
  return colors[key] || '#44D7A8'; // default: gray-200
}
export const gridOrderStatus = (props) => {
  const pastelbg=getStatusColor(props.Status)
  ...
  <button
    ...
    className="text-white w-20 py-1 px-2 capitalize rounded-2xl text-md hover:drop-shadow-xl"
  >
    {props.Status}
  </button>)
};
...
const customerGridStatus = (props) => {
  ...
  return(
  <div className="flex gap-2 justify-center items-center capitalize bg-opacity-20 ">
    <p className=" rounded-full h-6 w-24 flex justify-center items-center "  style={{  backgroundColor: `rgba(${hexToRgb(pastelbg)}, 0.2)` }} ><span style={{color: pastelbg,fontWeight:700}}>{props.Status}</span></p>
...
export const trendPair2 = [
  {
    ...
    iconColor: '#16A34A',
    iconBg: '#DCFCE7',
    pcColor: 'text-green-600',   // include full Tailwind class string
  ...
  },
  {
    ...
    trend: [2400, 5690, 1800, 3908, 9800, 3780, 9300],
  },
];
